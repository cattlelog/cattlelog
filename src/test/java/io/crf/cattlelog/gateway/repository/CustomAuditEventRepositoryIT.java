...
import io.crf.cattlelog.gateway.config.audit.AuditEventConverter;
import io.crf.cattlelog.gateway.domain.PersistentAuditEvent;
import io.crf.cattlelog.gateway.repository.CustomAuditEventRepository;
import io.crf.cattlelog.gateway.repository.PersistenceAuditEventRepository;
...
import static io.crf.cattlelog.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
